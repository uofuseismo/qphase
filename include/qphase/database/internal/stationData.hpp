#ifndef QPHASE_DATABASE_INTERNAL_STATION_HPP
#define QPHASE_DATABASE_INTERNAL_STATION_HPP
#include <memory>
#include <chrono>
namespace QPhase::Database::Internal
{
/// @name StationData "stationData.hpp" "qphase/database/internal/stationData.hpp"
/// @brief Defines a station's location.
...
[[nodiscard]] bool operator==(const StationData &lhs, const StationData &rhs);
[[nodiscard]] bool operator!=(const StationData &lhs, const StationData &rhs);
}
#endif
